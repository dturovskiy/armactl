...
- [ ] Implement the play-session-scoped current stats contract: automatic log ingest freshness, reconnect grace, reliable play-session boundaries, session-scoped Kills/Deaths/TK/Faction evidence, and no fake zeroes.
