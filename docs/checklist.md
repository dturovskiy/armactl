...
- [ ] Install and enable the explicit foreground player-log ingest runner in a later approved service/deploy slice, then verify that current stats become fresh without pressing the manual button; do not mark that acceptance complete from local foundation alone.
