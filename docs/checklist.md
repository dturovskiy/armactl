...
- [ ] Continue live session tracking with automatic poller/scheduler decisions, conflict windows, session UI/API, and remaining retention scheduling from the Phase 4a design, with no IP storage by default.
