...
- slice 4: implement the play-session-scoped stats contract: automatic log ingest freshness, parser fixture stability, reconnect grace, reliable play-session boundaries, and session-scoped Kills/Deaths/TK/Faction evidence with no fake zeroes;
