...
- slice 4: complete — F2-a/F2-b/F2-c supervised ingest deployment/observation now proves automatic fresh bounded log coverage on both target VMs; next prove the complete automatic session/stat pipeline with real players and no fake zeroes;
